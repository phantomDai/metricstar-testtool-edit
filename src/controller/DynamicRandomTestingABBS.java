...
public class DynamicRandomTestingABBS {
    ...
    public void testonefaultsforP(){
        ...
        //得到4个分区中的测试用例编号
        String path0 = "C:\\Users\\daihe\\Desktop\\ABBS\\partitions\\p0";
        String path1 = "C:\\Users\\daihe\\Desktop\\ABBS\\partitions\\p1";
        String path2 = "C:\\Users\\daihe\\Desktop\\ABBS\\partitions\\p2";
        String path3 = "C:\\Users\\daihe\\Desktop\\ABBS\\partitions\\p3";
        String path4 = "C:\\Users\\daihe\\Desktop\\ABBS\\partitions\\p4";
        String path5 = "C:\\Users\\daihe\\Desktop\\ABBS\\partitions\\p5";
        String path6 = "C:\\Users\\daihe\\Desktop\\ABBS\\partitions\\p6";
        String path7 = "C:\\Users\\daihe\\Desktop\\ABBS\\partitions\\p7";
        ...
        for (int i = 0; i < 20; i++) {
            ...
            while(flag){
                ...
                String testcase = "";
                do{
                    testcase = String.valueOf(random.nextInt(40));
...
//						System.out.println(counter);
    ...
    private String[] getNameoftestcases(String numberofscripts){
        String path = "C:\\Users\\daihe\\Desktop\\ABBS\\MyRandom1" + "\\" +
                numberofscripts + "\\" + "testAirlinesBaggageBillingService.java";
    ...
    private String[] isBelongtoOnePartition(String numberofscripts){
        ...
        try {
            ...
            bufferedReader.close();
            String sourcetestcase = source1 + source2;
            String followtestcase = follow1 + follow2;
    ...
    private int getPartitions(String testcasename){
        int result = 0 ;
        if (testcasename.equals("I-1aI-2a"))
            result = 0;
        else if (testcasename.equals("I-1aI-2b"))
            result = 1;
        else if (testcasename.equals("I-1bI-2a"))
            result = 2;
        else if (testcasename.equals("I-1bI-2b"))
            result = 3;
        else if (testcasename.equals("I-1cI-2a"))
            result = 4;
        else if (testcasename.equals("I-1cI-2b"))
            result = 5;
        else if (testcasename.equals("I-1dI-2a"))
            result = 6;
        else if (testcasename.equals("I-1dI-2b"))
            result = 7;
        return result;
    }
